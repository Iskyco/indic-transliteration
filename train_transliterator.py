...
class Transliterator(object):
    ...
    def create_model(self):
        """
        Creates tensorflow variables and graph
        """
    ...
    def train(self, learning_rate=0.05, momentum=0.9, batch_size=64, num_epochs=100):
        ...
        # loss and optimizer
        loss = tf.nn.seq2seq.sequence_loss(self.dec_outputs, self.labels, self.weights)
...
if __name__ == '__main__':
    trans = Transliterator(get_transliteration_pairs('data/Hindi - Word Transliteration Pairs 1.txt'))
    trans.train()